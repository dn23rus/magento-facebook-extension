 ...
 */
class Oggetto_Facebook_Model_System_Config_Source_Color
{
    ...
    public function toOptionArray()
    {
        return array(
            array(
                ...
                'label' => Mage::helper('oggetto_fb')->__('Light'),
            ),
            array(
                'value' => 'dark',
                'label' => Mage::helper('oggetto_fb')->__('Dark'),
            ),
        );
    }
}
